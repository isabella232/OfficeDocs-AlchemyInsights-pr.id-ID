...
[Mengembalikan dihapus OneDrive situs](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)

Untuk tindakan massal recycle bin, admin dapat mempertimbangkan menggunakan [Sharepoint Online PNP](https://docs.microsoft.com/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps).
