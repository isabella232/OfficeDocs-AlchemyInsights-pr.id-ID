...
Tips:
- Admin SharePoint sekarang dapat menghapus situs milik **Microsoft 365 grup**. Ini akan menghapus grup dan semua sumber dayanya, termasuk kotak surat Outlook dan kalender, dan setiap saluran teams. Untuk informasi lebih lanjut, lihat [menghapus situs SharePoint](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center#delete-a-site)
