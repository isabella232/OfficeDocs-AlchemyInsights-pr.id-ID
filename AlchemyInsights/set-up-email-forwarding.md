...
Untuk informasi selengkapnya, lihat [mengkonfigurasi penerusan email di Microsoft 365](https://docs.microsoft.com/office365/admin/email/configure-email-forwarding).
...
Apakah Anda memiliki karyawan yang pergi? Lihat [menghapus mantan karyawan dari Microsoft 365](https://docs.microsoft.com/office365/admin/add-users/remove-former-employee) untuk langkah yang disarankan.