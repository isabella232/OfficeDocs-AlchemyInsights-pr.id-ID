...
---
# <a name="how-to-delete-a-folder"></a>Bagaimana menghapus folder

1. Di panel folder, klik kanan folder atau subfolder yang ingin Anda hapus.
2. Pilih **Hapus folder**.
3. Pilih **OK** untuk konfirmasi.
