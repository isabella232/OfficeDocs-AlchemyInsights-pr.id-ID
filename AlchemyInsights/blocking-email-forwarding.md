...
---
# <a name="block-email-forwarding"></a>Blokir penerusan email

Untuk menonaktifkan penerusan email untuk kotak surat tertentu, lihat [mengonfigurasi penerusan email](https://docs.microsoft.com/microsoft-365/admin/email/configure-email-forwarding).
