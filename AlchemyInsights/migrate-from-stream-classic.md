...
Untuk informasi selengkapnya tentang melakukan migrasi dari aliran klasik ke aliran baru, lihat, [melakukan migrasi dari Microsoft Stream (klasik) ke Microsoft Stream baru](https://docs.microsoft.com/stream/classic-migration)