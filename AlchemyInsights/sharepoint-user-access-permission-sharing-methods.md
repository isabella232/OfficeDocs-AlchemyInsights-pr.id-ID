...
---
# <a name="sharing-and-permission-methods-to-provide-or-restrict-user-access-to-sharepoint-site"></a>Berbagi dan izin metode untuk memberikan atau membatasi akses pengguna ke situs SharePoint

Setelah Anda membuat situs SharePoint, Anda mungkin ingin memberikan atau membatasi akses pengguna ke situs atau isinya. Hal ini dapat dilakukan melalui berbagai metode berbagi dan izin yang tercantum di bawah ini.
...
- [Mengubah jenis tautan default saat pengguna mendapatkan tautan untuk berbagi](https://docs.microsoft.com/sharepoint/change-default-sharing-link)
...
- [Berbagi dan perizinan](https://support.office.com/article/Sharing-and-permissions-ac85fbf1-2431-49bf-8690-f1a2b98af65f#ID0EAABAAA=Manage_permissions)
