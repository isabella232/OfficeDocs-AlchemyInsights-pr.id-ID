...
Untuk mengakses halaman domain, cukup klik ikon ini di bawah ini:
...
Selanjutnya, Anda dapat menambahkan, mengubah, atau menghapus domain.
Untuk informasi selengkapnya, lihat [FAQ domain.](https://docs.microsoft.com/office365/admin/setup/domains-faq)
