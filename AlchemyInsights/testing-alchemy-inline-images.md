---
title: Menguji Alkimia gambar inline
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669395"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="25a45-102">Mengakses halaman domain</span><span class="sxs-lookup"><span data-stu-id="25a45-102">Access the Domains Page</span></span>

<span data-ttu-id="25a45-103">Untuk mengakses halaman domain, cukup klik ikon ini di bawah ini:</span><span class="sxs-lookup"><span data-stu-id="25a45-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="25a45-104">Lalu Anda dapat menambahkan, mengubah, atau menghapus domain Anda.</span><span class="sxs-lookup"><span data-stu-id="25a45-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="25a45-105">Untuk informasi selengkapnya, lihat [FAQ domain.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="25a45-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
