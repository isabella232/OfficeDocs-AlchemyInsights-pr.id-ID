...
---
# <a name="add-users-to-a-sharepoint-group"></a>Menambahkan pengguna ke grup SharePoint
...
- [Menambah atau menghapus anggota dari Office 365 grup menggunakan pusat admin](https://docs.microsoft.com/office365/admin/create-groups/add-or-remove-members-from-groups?view=o365-worldwide)