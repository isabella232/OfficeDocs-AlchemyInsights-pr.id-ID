...
---
# <a name="sending-email-as-the-shared-mailbox"></a>Mengirim email sebagai kotak surat bersama

Setelah Anda membuat kotak surat bersama, pengguna yang merupakan anggota kotak surat dapat mengirim email sebagai identitas kotak surat bersama (misalnya,  *Info@contoso.com*  ). Untuk instruksi, lihat:
