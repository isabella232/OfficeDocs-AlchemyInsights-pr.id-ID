...
Untuk menambahkan domain yang sudah Anda miliki, ikuti [panduan Tambahkan domain](https://admin.microsoft.com/Adminportal/Domains/Wizard), atau buka pengaturan domain **Settings**  >  **Domains**  >  **Tambahkan domain**.
...
Untuk pertanyaan tentang domain, lihat [FAQ domain](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq).
