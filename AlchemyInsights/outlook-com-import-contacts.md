...
ms.locfileid: "53962206"
---
# <a name="import-contacts"></a>Mengimpor kontak

Sebelum mengimpor kontak ke Outlook.com, Anda harus mengekspor kontak dari penyedia email lain sebagai .csv kontak. Lalu, ikuti instruksi di bawah ini.
...
.
2. Di bagian atas halaman, pilih **Kelola** \> **Impor kontak**.
3. Pilih **Telusuri**, navigasikan ke folder tempat Anda menyimpan kontak yang diekspor, dan pilih **Buka**.

Untuk mempelajari selengkapnya, lihat [Mengimpor kontak ke Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
