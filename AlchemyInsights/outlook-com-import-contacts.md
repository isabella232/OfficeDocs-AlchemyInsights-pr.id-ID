...
Sebelum mengimpor kontak ke Outlook.com, Anda harus mengekspornya dari penyedia email lain sebagai file. CSV. Kemudian, ikuti petunjuk di bawah ini.
...
.
2. Di bagian atas halaman, pilih **Kelola** \> **kontak impor**.
3. Pilih **Telusuri**, navigasikan ke folder tempat Anda menyimpan kontak yang diekspor, lalu pilih **buka**.

Untuk mempelajari lebih lanjut, lihat [mengimpor kontak ke Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).