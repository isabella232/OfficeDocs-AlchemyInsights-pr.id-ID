...
---
# <a name="disable-myanalytics"></a>Menonaktifkan MyAnalytics

Untuk menonaktifkan MyAnalytics, lihat [menyisih dari myanalytics](https://docs.microsoft.com/workplace-analytics/myanalytics/use/opt-out-of-mya). 
