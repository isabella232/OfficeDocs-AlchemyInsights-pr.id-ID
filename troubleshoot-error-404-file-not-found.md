...
Untuk modern situs (komunikasi, terhubung ke grup, atau situs lain) yang ada di pusat admin baru pratinjau, lihat [Lihat dan memulihkan dihapus situs di SharePoint admin center baru](https://docs.microsoft.com/en-us/sharepoint/restore-deleted-site-collection).
